#!/bin/bash
#
# Configuration script for 666c (CLIENT node)
# This node will communicate only through bb14 repeater
# It will NOT see 7284 directly
#
# Usage: ./configure_666c_client.sh [CHANNEL_URL]
...
echo "=========================================="
echo "Configuring 666c as CLIENT"
echo "IP: $IP_ADDRESS"
echo "=========================================="
echo ""
...
# Verify connection
echo "1. Verifying connection to 666c at $IP_ADDRESS..."
python3 -m meshtastic --host "$IP_ADDRESS" --info | grep -E "Owner|666c" || {
    echo "❌ Error: Could not connect to 666c at $IP_ADDRESS"
...
echo "=========================================="
echo "✅ 666c CLIENT configuration complete!"
echo "=========================================="
echo ""
...
echo "and will NOT see 7284 directly (if properly isolated)"
echo ""
